...
Mockito is a Java library used in testing to create fake versions of objects.

Think of it like this:

* When you test a class, it often depends on other classes (like database, APIs, services)
* You don’t want to call the real database or API during testing
* So you create a mock (fake object) that behaves the way you want

That’s exactly what Mockito helps you do.
...
* You have a UserService that calls UserRepository
* Instead of using the real repository, you create a mock repository
* You tell it: “when this method is called, return this value”
* Then you test your service logic

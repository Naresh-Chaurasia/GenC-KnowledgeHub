...
It is just a nickname for the remote GitHub repository.

Instead of writing the full long GitHub URL every time, Git uses the short name origin.
----
...
* #Push Pull Without Branches#.
** Git clone in 2 directories, and push from one and pull from another.
